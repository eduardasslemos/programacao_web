...
const maiusculaLambda = (f: string): string => {return f.toUpperCase()};


console.log(maiuscula("banana"));
console.log(maiusculaLambda("kiwi"));
...
//Crie uma função chamada dobrarNumeros que recebe
// um array de números e retorna um novo array com
// todos os valores multiplicados por 2.
...
function dobrarNumeros (numeros: number[]): number[]{
    ...
    for(let i = 0; i < numeros.length; i++){
        ...
        //o ! mostra q o numeros[i] nao eh undefined,
        // pq estava dando erro nisso
    }
...
//Dado um array de alunos e suas respectivas notas,
//escreva uma função tipada que utilize filter() para
//retornar apenas os alunos aprovados.
...
//Dado um array de eventos tipados,
//filtre apenas aqueles que ocorrem em um determinado mês.
